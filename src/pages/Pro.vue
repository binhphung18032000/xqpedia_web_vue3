  ...
  <div>
    <div class="flex justify-between">
      <h1 class="flex text-white text-3xl font-medium">
        <img src="/images/pro.svg" class="w-12 h-12" alt="Vô địch tỉnh" />
        <span class="ml-2">Vô địch tỉnh</span>
      </h1>
...
export default {
  ...
  methods: {
    ...
    newGameOppo() {
      if (this.isPlaying) {
        ...
        this.$router.push({ name: "pro-oppo" });
      }
    },
    retry() {
      this.closeModal();
  ...
  head() {
    return {
      title: "Khiêu chiến vô địch tỉnh | XQPedia",
      meta: [
        {
          property: "og:title",
          content: "Khiêu chiến vô địch tỉnh | XQPedia",
        },
        {
        ...
        {
          property: "og:image",
          content: process.env.APP_URI + "images/logo-pro.jpg",
        },
        {
          property: "og:url",
