  ...
  <div>
    <div class="flex justify-between">
      <h1 class="flex text-white text-3xl font-medium">
        <img src="/images/semi.svg" class="w-12 h-12" alt="Vô địch huyện" />
        <span class="ml-2">Vô địch huyện</span>
      </h1>
      <div
    ...
    >
      ...
      >
        ...
        <div class="modal-content py-4 text-left px-6">
          ...
          <p>Bạn đã thắng vô địch huyện</p>
          <!--Footer-->
...
export default {
  ...
  methods: {
    ...
    newGameOppo() {
      if (this.isPlaying) {
        ...
        this.$router.push({ name: "semi-oppo" });
      }
    },
    retry() {
      this.closeModal();
  ...
  head() {
    return {
      title: "Khiêu chiến vô địch huyện | XQPedia",
      meta: [
        {
          property: "og:title",
          content: "Khiêu chiến vô địch huyện | XQPedia",
        },
        {
        ...
        {
          property: "og:image",
          content: process.env.APP_URI + "images/logo-semi.jpg",
        },
        {
          property: "og:url",
